...
export default function MicrosoftPage() {
  const [connection, setConnection] = useState<MicrosoftConnection | null>(
    null
  );
  ...
  const handleSync = async () => {
    ...
    try {
      ...
      alert('Microsoft 365 への接続設定が必要です。');
    } catch (error) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Microsoft 365 連携</h1>
          <p className="mt-2 text-gray-600">
            Microsoft 365 アカウントの管理と同期
          </p>
        </div>
        ...
        <CardContent>
          {connection ? (
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <span className="font-medium">テナントID</span>
                <span className="font-mono text-sm">{connection.tenantId}</span>
              </div>
              <div className="flex items-center justify-between">
      ...
      <Tabs defaultValue="users" className="space-y-4">
        <TabsList>
          ...
          <TabsTrigger value="licenses">ライセンス</TabsTrigger>
        ...
        <TabsContent value="licenses" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>ライセンス管理</CardTitle>
              <CardDescription>
                Microsoft 365 ライセンスの使用状況
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  <div className="rounded-lg border p-4">
                    ...
                    <p className="text-sm text-gray-600">使用中 / 総数</p>
                  </div>
                  <div className="rounded-lg border p-4">
                    <h3 className="mb-2 font-medium">Power BI Pro</h3>
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between rounded border p-3">
                    ...
                    <Badge variant="outline">全ユーザー</Badge>
                  </div>
                  <div className="flex items-center justify-between rounded border p-3">
                    <div className="flex items-center gap-2">
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="font-medium">ライセンス自動割当</h3>
                    <p className="text-sm text-gray-600">
                      新規ユーザーへのライセンス自動割当
                    </p>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h3 className="font-medium">Teams チーム同期</h3>
                    <p className="text-sm text-gray-600">
                      部門別Teamsチームの自動作成
                    </p>
                  </div>
        ...
        <TabsContent value="logs" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Microsoft 365 連携の操作履歴</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-2">
                <div className="flex items-center justify-between rounded border p-3">
